...
export const projectAcpSessionsTable = sqliteTable('project_acp_sessions', {
  ...
  name: text('name'),
  acpStatus: text('acp_status').notNull(),
  acpError: text('acp_error'),
  ...
  supervisionPolicyJson: text('supervision_policy_json').notNull(),
  deadlineAt: text('deadline_at'),
  inactiveDeadlineAt: text('inactive_deadline_at'),
...
export const projectTasksTable = sqliteTable('project_tasks', {
  ...
  verificationCommandsJson: text('verification_commands_json'),
  ...
  laneSessionsJson: text('lane_sessions_json'),
  laneHandoffsJson: text('lane_handoffs_json'),
  codebaseIdsJson: text('codebase_ids_json'),
