...
import { CollectionJsonStateFactory } from './state/collection-json-state/collection-json-state.factory.js';
...
export class ClientInstance implements Client {
  ...
  constructor(
    ...
    private readonly collectionJsonStateFactory: CollectionJsonStateFactory = new CollectionJsonStateFactory(),
    ...
    this.registerContentType(
      ...
      this.collectionJsonStateFactory,
      '0.8',
    );
