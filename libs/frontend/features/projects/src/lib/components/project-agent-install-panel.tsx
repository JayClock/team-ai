...
export type ProjectAgentInstallPanelProps = {
...
export function ProjectAgentInstallPanel({
                      ...
                      <div className="shrink-0">
                        {canInstall ? (
                          <Button
                            ...
                            disabled={installing}
                            className="h-8 rounded-lg bg-indigo-600 px-3 text-xs text-white hover:bg-indigo-700 disabled:opacity-60"
                          >
                            {installing ? (
                          ...
                          <Button
                            ...
                            variant="outline"
                            disabled
                            className="h-8 rounded-lg px-3 text-xs opacity-60"
                          >
