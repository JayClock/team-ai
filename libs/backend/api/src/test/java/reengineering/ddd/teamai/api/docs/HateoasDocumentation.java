...
/**
 * Reusable documentation helpers for HATEOAS + HAL-FORMS APIs. Designed for
 * internal developers,
...
public final class HateoasDocumentation {
  ...
  /**
   * Creates a HAL links snippet with the given link descriptors. This is a
   * convenience method that
   * wraps HypermediaDocumentation.links() with HAL extractor. Uses relaxed mode
   * to ignore
   * undocumented links.
   */
