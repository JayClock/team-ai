...
import static com.businessdrivenai.api.docs.HateoasDocumentation.conversationResponseFields;
import static com.businessdrivenai.api.docs.HateoasDocumentation.createConversationRequestFields;
import static com.businessdrivenai.api.docs.HateoasDocumentation.halLinksSnippet;
import static com.businessdrivenai.api.docs.HateoasDocumentation.messagesLink;
import static com.businessdrivenai.api.docs.HateoasDocumentation.pagedConversationsResponseFields;
import static com.businessdrivenai.api.docs.HateoasDocumentation.paginationLinks;
import static com.businessdrivenai.api.docs.HateoasDocumentation.paginationParameters;
import static com.businessdrivenai.api.docs.HateoasDocumentation.selfLink;
import static com.businessdrivenai.api.docs.HateoasDocumentation.sendMessageLink;
...
public class ConversationsApiTest extends ApiTest {
    ...
    given(documentationSpec)
        ...
        .filter(
            document(
                ...
                paginationLinks()))
        .when()
        .get("/projects/{projectId}/conversations", project.getIdentity())
        .then()
        .statusCode(200)
        .body(
            "_links.self.href",
            is("/api/projects/" + project.getIdentity() + "/conversations?page=0"))
        .body(
            "_links.next.href",
            is("/api/projects/" + project.getIdentity() + "/conversations?page=1"))
  ...
  public void should_create_new_conversation() {
    ...
    given(documentationSpec)
        ...
        .body(description)
        .when()
        .post("/projects/{projectId}/conversations", project.getIdentity())
        .then()
        .statusCode(201)
        .header(
