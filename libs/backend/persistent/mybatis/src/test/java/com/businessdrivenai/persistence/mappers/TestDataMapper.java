...
public interface TestDataMapper {
  ...
  @Insert(
      "INSERT INTO logical_entities(id, project_id, type, sub_type, name, label, definition, status) VALUES (#{id}, #{project_id}, #{type, typeHandler=com.businessdrivenai.persistence.mybatis.typehandler.LogicalEntityTypeHandler}, #{sub_type, typeHandler=com.businessdrivenai.persistence.mybatis.typehandler.SubTypeHandler}, #{name}, #{label}, CAST(#{definition} AS jsonb), #{status})")
