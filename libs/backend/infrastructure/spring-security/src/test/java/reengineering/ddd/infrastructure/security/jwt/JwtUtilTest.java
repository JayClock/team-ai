...
class JwtUtilTest {
    ...
    void should_return_empty_for_token_signed_with_different_secret() {
        ...
        JwtUtil differentJwtUtil = new JwtUtil("different-secret-key-that-is-also-long", TEST_EXPIRATION_MS);
    ...
    void should_handle_short_secret_by_padding() {
        ...
        when(user.getDescription()).thenReturn(new UserDescription("Short Secret User", "short@test.com"));
