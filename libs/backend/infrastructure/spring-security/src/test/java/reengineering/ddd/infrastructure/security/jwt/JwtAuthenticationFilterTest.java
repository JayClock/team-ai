...
class JwtAuthenticationFilterTest {
    ...
    void should_prefer_cookie_token_over_header() throws ServletException, IOException {
        ...
        assertThat(SecurityContextHolder.getContext().getAuthentication().getPrincipal()).isEqualTo(cookieUserId);
    }

    @Test
    void should_continue_filter_chain_without_authentication_when_no_token() throws ServletException, IOException {
        when(request.getCookies()).thenReturn(null);
    ...
    @Test
    void should_continue_filter_chain_without_authentication_when_token_invalid() throws ServletException, IOException {
